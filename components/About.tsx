...
const techSkills = [
  ...
  },
  {
    ...
    skills: ["React", "Next.js", "Vite", "HTML", "CSS", "Tailwind CSS", "REST APIs"]
  },
  {
    category: "Backend & Databases",
    skills: ["FastAPI", "PostgreSQL", "MySQL", "Supabase", "Neon", "Prisma"]
  },
  {
    category: "Data Science & ML",
    skills: ["NumPy", "Pandas", "Scikit-learn", "Matplotlib", "Seaborn", "SciPy"]
  },
  {
    category: "Cloud & Infrastructure",
    skills: ["AWS", "Google Cloud", "Cloudflare", "DigitalOcean", "Hetzner", "Docker", "Cloudinary"]
  },
  {
    category: "Tools & APIs",
    skills: ["Git", "GitHub", "Google APIs", "Razorpay"]
  }
];
    ...
    <section className="w-full bg-transparent py-32 px-6 overflow-hidden" id="about">
      <div className="max-w-7xl mx-auto space-y-48">
        ...
        <div className="space-y-16 pt-16">
          ...
          <div className="max-w-5xl mx-auto flex flex-col border-t border-white/10 mt-16">
            {techSkills.map((section, i) => (
              <motion.div
                ...
                className="flex flex-col md:flex-row md:items-center justify-between py-8 border-b border-white/10 group"
              >
                <div className="md:w-1/3 mb-6 md:mb-0">
                  <h3 className="text-xl md:text-2xl font-display tracking-tight text-neutral-500 group-hover:text-emerald-400 transition-colors duration-300">
                    {section.category}
                  </h3>
                </div>
                <div className="md:w-2/3 flex flex-wrap gap-3">
                  {section.skills.map((skill, idx) => (
                    <span 
                      key={idx} 
                      className="px-4 py-2 text-sm font-mono rounded-full bg-white/5 border border-white/10 text-neutral-300 group-hover:border-emerald-500/30 group-hover:bg-emerald-500/5 transition-all duration-300"
                    >
                      {skill}
                    </span>
                  ))}
