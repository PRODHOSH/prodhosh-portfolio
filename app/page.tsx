                ...
                <div className="relative w-[16.5rem] h-[21rem] md:w-[20rem] md:h-[25rem] rounded-full shadow-2xl">
                  ...
                  <div className="absolute inset-[22px] rounded-full overflow-hidden">
                    <Image
                      ...
                      width={1000}
                      height={1400}
                      className="w-full h-full object-cover object-center [object-position:50%_60%]"
                      priority
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex gap-4 flex-wrap items-center">
                      <span className="text-primary text-sm font-semibold font-mono flex items-center gap-2">
              ...
              <div className="relative w-full aspect-video bg-gradient-to-br from-primary/10 to-accent/10 rounded-lg overflow-hidden mb-6">
                ...
                {selectedCert.pending && (
                  <div className="absolute inset-0 z-10 flex flex-col items-center justify-center">
                    <div className="bg-background/80 backdrop-blur-sm rounded-2xl px-8 py-6 flex flex-col items-center shadow-lg">
                      <div className="w-12 h-12 rounded-full animate-spin mb-3 ring-4 ring-primary/30 ring-offset-2 ring-offset-background" aria-label="Loading" />
